...
- order
```
 http :8088/orders id="id" productId="productId" price="price" point="point" quantity="quantity" userId="userId" status="status" 
```
- inventory
```
...
- payment
```
 http :8088/pays id="id" orderId="orderId" payAmount="payAmount" userId="userId" status="status" 
```
